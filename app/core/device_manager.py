...
class DeviceManager:
    ...
    def create_device(
        ...
        return BaseDevice(
            ...
            home_id=str(raw_device.get("home_id") or ""),
            home_name=str(raw_device.get("home_name") or ""),
            room_id=str(raw_device.get("room_id") or ""),
            room_name=str(raw_device.get("room_name") or ""),
